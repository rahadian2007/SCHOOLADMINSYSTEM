    ...
    <form method="POST" action="/users/{{ $user->id }}">
        ...
        <div class="d-flex mb-3">
          ...
          <div class="input-group">
              ...
              <input class="form-control"
                ...
                name="phone"
                value="{{ $user->detail ? $user->detail->phone : '' }}"
                required
              />
          </div>
        </div>
        ...
        <div class="d-flex mb-3">
          <input class="form-control mr-1"
            ...
            name="place_of_birth"
            value="{{ $user->detail ? $user->detail->place_of_birth : '' }}"
          />
          <input class="form-control"
            type="date"
            placeholder="{{ __('Birth date') }}"
            name="date_of_birth"
            value="{{ $user->detail ? $user->detail->date_of_birth : '' }}"
          />
        </div>
        <textarea class="form-control mb-3"
          ...
          name="address"
        >{{ $user->detail ? $user->detail->address : '' }}</textarea>
        ...
        <x-forms.button href="{{ url()->previous() }}"
          preset="default"
        >
          {{ __('Back') }}
        </x-forms.button>
